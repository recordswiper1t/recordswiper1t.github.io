package
{
   ...
   [Embed(source="/_assets/assets.swf", symbol="symbol13991")]
   public class SoldierHeroDragonLongRangeAttackExplosion1 extends §extends const true§
   {
      ...
      public function SoldierHeroDragonLongRangeAttackExplosion1(param1:Point, param2:Level, param3:Number, param4:Number)
      {
         super();
         this.damage = param3;
         this.range = param4;
