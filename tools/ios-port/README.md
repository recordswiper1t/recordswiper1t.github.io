...
This directory is the migration path from the 15-stage Flash/SWF browser mod to a full-content iPhone App Store release of Kingdom Rush Frontiers.

## Target

The source target is the user's legitimately purchased **Kingdom Rush Frontiers TD** iPhone app. The mobile build is different from the old Flash SWF used by this repository and can contain later content that the SWF build does not.
