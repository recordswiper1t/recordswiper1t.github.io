...
$EpicWar5Expansion = Join-Path $Root 'assets\epic-war-5-expansion-v38.swf'
...
switch ($Game) {
    ...
    { $_ -in @('epicwar5-expansion','epic-war-5-expansion','ew5-expansion') } {
        $Game = 'epicwar5-expansion'; $Swf = $EpicWar5Expansion; $GameLabel = 'Epic War 5 Expansion V3.8'; break
    }
