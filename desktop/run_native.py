...
GAME_FILES = {
    ...
    "epicwar5": ROOT / "assets" / "epic-war-5-expansion-v34.swf",
    "epicwar5-expansion": ROOT / "assets" / "epic-war-5-expansion-v34.swf",
    "epicwar5-stable": ROOT / "assets" / "epic-war-5-sandbox-v2.swf",
}
GAME_ALIASES = {
    "krf": "krf",
    "kingdom-rush": "krf",
    ...
    "epicwar5-stable": "epicwar5-stable",
    "epic-war-5-stable": "epicwar5-stable",
    "ew5-stable": "epicwar5-stable",
}
GAME_LABELS = {
    "krf": "Kingdom Rush Frontiers",
    "stickwar": "Super Stick War (SW1 + SW2)",
    "epicwar5": "Epic War 5 Expansion V3.4",
    "epicwar5-expansion": "Epic War 5 Expansion V3.4",
    "epicwar5-stable": "Epic War 5 stable V1.05-based fallback",
}
...
def choose_game(value: str) -> tuple[str, Path]:
    ...
    if not key:
        raise SystemExit(f"Unknown game {value!r}. Choose krf, stickwar, epicwar5, epicwar5-expansion, or epicwar5-stable.")
    if key == "krf":
...
def main() -> int:
    ...
    parser.add_argument("--game", default="krf", help="krf, stickwar, epicwar5, epicwar5-expansion, or epicwar5-stable (default: krf)")
