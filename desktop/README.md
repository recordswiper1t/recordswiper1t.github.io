...
- `stickwar` launches `assets/stick-war-complete-v31.swf`, the released 65-stage SW1+SW2 expansion with a visible clickable sandbox and adaptive 12× speed.
- `epicwar5` launches the stable V1.05-based Sandbox V2 build.
- `epicwar5-expansion` launches `assets/epic-war-5-expansion-v43.swf`, the released V4.3 Expansion with repaired Continue/direct entry, compact circular slots 7–12, a dark bronze/crimson animated soldier-card Battle Forge, adaptive 8× speed and immediate Instant Win. Native play keeps the normal campaign unlock requirement.
